...
void* stack_pop(struct stack* stack) {
  void* val = list_get(stack->list, 0);
  list_remove_at(stack->list, 0);
  return val;
}

/*
 * Added two functions to list to implement stack:
