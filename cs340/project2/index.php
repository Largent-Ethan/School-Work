                    ...
                    if($result = mysqli_query($link, $sql)){
                        if(mysqli_num_rows($result) > 0){
                            echo "<table class='table table-bordered table-striped'>";
                                echo "<thead>";
                                    echo "<tr>";
                                        echo "<th width=9%>SSN</th>";
                                        echo "<th width=10%>First Name</th>";
                                        echo "<th width=10%>Last Name</th>";
                                        echo "<th width=20%>Address</th>";
										echo "<th width=10%>Birthdate</th>";
										echo "<th width=6%>Salary</th>";
                                        echo "<th width=12%>Level</th>";
                                        echo "<th width=9%>Super SSN</th>";
										echo "<th width=6%>Dno</th>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            ...
                                            echo "<a href='program2_viewDependent.php?Ssn=". $row['Ssn'] ."' title='View Dependents' data-toggle='tooltip'><span class='glyphicon glyphicon-user'></span></a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
