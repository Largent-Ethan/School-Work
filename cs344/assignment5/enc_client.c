...
char* getMessage(char* key, char* plaintext) {
  char* myString = calloc(MAXCHAR, sizeof(char)), *tempStr_pt = calloc(MAXCHAR, sizeof(char)), *tempStr_ky = calloc(MAXCHAR, sizeof(char));
  FILE *myFile;
...
/*****************************************
 * Send the message to the server to be  encrypted
*****************************************/
